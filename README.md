This C program simulates a basic cricket scoreboard for two teams. It allows the user to input team details, including the team name, captain's name, and player names along with their respective runs. 
